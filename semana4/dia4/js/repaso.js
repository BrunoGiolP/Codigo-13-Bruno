...
const mascotas = [
  ...
  /*const cursoFiltroJs = arregloCursos.filter((curso) => curso.tec === "JS");
  const cursoFiltroPython = arregloCursos.filter((curso) => curso.tec === "Python");
  const cursoFiltrophp = arregloCursos.filter((curso) => curso.tec === "PHP");
  
  console.log("Curso JS", cursoFiltroJs);
  console.log("Curso JS", cursoFiltroPython);
  console.log("Curso JS", cursoFiltrophp);
  */
